...
interface DoublePerformanceCardProps {
  totalMatchesCount: number;
  winsCount: number;
  winRate: number;
}

export default function DoublePerformanceCard({
  totalMatchesCount,
  winsCount,
  winRate
}: DoublePerformanceCardProps) {
  ...
  return (
    <div className="glass p-6 space-y-5">
      <h3 className="text-xs font-black uppercase tracking-widest text-zinc-400 flex items-center gap-1.5">
        <TrendingUp className="w-4 h-4 text-primary" /> Hiệu suất thi đấu bộ đôi
      </h3>
